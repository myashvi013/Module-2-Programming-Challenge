...
// Remover: Removes unessary items to not use all computer memory 
template <typename T>
...
bool LinkedList<T>::remove(T val) {
    ...
    // Interirates through the items until item found or list finished
...
// Gets the code ready so it can hold intergers
