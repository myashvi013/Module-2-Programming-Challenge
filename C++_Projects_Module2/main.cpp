...
int main(){
    ...
    std::cout<<"Show 1: Creating numbers with a magic loop...\n";
    ...
    std::cout<<"Removing the head(7)...";
    playList.remove(7);
    std::cout<<"List: "<<playList<<"\n";
    std::cout<<"Removing the middle one(21)...";
    playList.remove(21);
    std::cout<<"List: "<<playList<<"\n";
    std::cout<<"Removing the tail(35)...";
    playList.remove(35);
    std::cout<<"List: "<<playList<<"\n\n";
    std::cout<<"Show 4: Attempting to remove an imaginary number (√-404)...";
